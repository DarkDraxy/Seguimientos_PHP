...
return [
    'menu' => [
        ...
        ['route' => 'events.index', 'label' => 'Calendario de Eventos', 'icon' => '🗓️'],
        ['route' => 'recipes.index', 'label' => 'Plataforma de Recetas', 'icon' => '🍳'],
        ['route' => 'memory.index', 'label' => 'Juego de Memoria', 'icon' => '🎮'],
        ['route' => 'surveys.index', 'label' => 'Plataforma de Encuestas', 'icon' => '📋'],*/
    ],
];
